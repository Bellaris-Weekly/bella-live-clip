...
当前版本为 `2.0.2`。B 站直播片段剪辑与下载油猴脚本。

可安装的油猴脚本，支持贝拉、乃琳、嘉然、心宜、思诺的本场直播回看与近 14 天历史回放。浅色面板采用暖白、灰绿和青绿色。
...
默认快捷键为 **Alt＋Shift＋C**。点击面板右上角快捷键可修改。窗口和入口均可拖动，窗口八个方向可缩放并记住位置。
...
- **松开边界，时间轴自动适配当前完整选区。** 两侧保留约 6% 余量；向外拖动可以扩大选区。滚轮缩放，Shift＋滚轮平移，也可用“整场”恢复全局。
